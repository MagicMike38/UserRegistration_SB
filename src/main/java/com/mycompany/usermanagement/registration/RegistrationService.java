...
import com.mycompany.usermanagement.appuser.AppUser;
import com.mycompany.usermanagement.appuser.AppUserRole;
import com.mycompany.usermanagement.appuser.AppUserService;
import com.mycompany.usermanagement.email.EmailSender;
...
public class RegistrationService {
    ...
    public String confirmToken(String token) {
        ...
        //make the status of user active
        AppUser appUser = confirmationToken.getAppUser();
        appUserService.activate(appUser.getEmail());
